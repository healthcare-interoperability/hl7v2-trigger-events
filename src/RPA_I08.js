...
export class RPA_I08 extends TriggerEvent {
    static TriggerEvent = 'RPA_I08';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'AUT', sequence: '6', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['AUTHORIZATION'] },
                    { identifier: 'CTD', sequence: '7', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['AUTHORIZATION'] },
                    ...
                    { identifier: 'AUT', sequence: '21', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['PROCEDURE', 'AUTHORIZATION2'] },
                    { identifier: 'CTD', sequence: '22', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['PROCEDURE', 'AUTHORIZATION2'] },
                ...
                groups: {
                    AUTHORIZATION: { sequence: { start: '6', stop: '7' }, restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, subgroup: {} },
                    PROVIDER: { sequence: { start: '8', stop: '9' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} },
                    INSURANCE: { sequence: { start: '13', stop: '15' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} },
                    PROCEDURE: {
                        sequence: { start: '20', stop: null },
                        restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 },
                        subgroup: { AUTHORIZATION2: { sequence: { start: '21', stop: '22' }, restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, subgroup: {} } },
                    },
                    OBSERVATION: {
