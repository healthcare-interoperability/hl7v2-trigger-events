import { MSH, MSA, ERR, NTE, PID, ORC, RQD } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ORS_O02 extends TriggerEvent {
    static TriggerEvent = 'ORS_O02';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
                ...
                groups: {
                    RESPONSE: {
                        ...
                        subgroup: {
                            ...
                            ORDER: { sequence: { start: '7', stop: '9' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} },
                        },
                    },
                },
            },
        ...
        segments: { MSH: MSH, MSA: MSA, ERR: ERR, NTE: NTE, PID: PID, ORC: ORC, RQD: RQD },
    };
