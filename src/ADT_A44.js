...
export class ADT_A44 extends TriggerEvent {
    static TriggerEvent = 'ADT_A44';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
            ...
            2.3: {
                ...
                groups: { PATIENT: { sequence: { start: '3', stop: '5' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} } },
            },
            '2.3.1': {
                sequences: { ref: '2.3' },
                groups: { ref: '2.3' },
            ...
            2.4: {
                ...
                groups: { PATIENT_ID: { sequence: { start: '3', stop: '5' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} } },
            },
            2.5: {
                sequences: [
                    {},
                ...
                groups: { PATIENT_ID: { sequence: { start: '4', stop: '6' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} } },
            },
            '2.5.1': {
                sequences: { ref: '2.5' },
                groups: { ref: '2.5' },
