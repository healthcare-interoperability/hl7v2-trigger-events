import { MSH, MSA, ERR, NTE, PID, ORC, RXO, RXR, RXC } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class RRO_O02 extends TriggerEvent {
    static TriggerEvent = 'RRO_O02';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
        ...
        segments: { MSH: MSH, MSA: MSA, ERR: ERR, NTE: NTE, PID: PID, ORC: ORC, RXO: RXO, RXR: RXR, RXC: RXC },
    };
