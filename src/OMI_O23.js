import { MSH, SFT, UAC, NTE, PID, PD1, PRT, ARV, PV1, PV2, IN1, IN2, IN3, GT1, AL1, ORC, TQ1, TQ2, OBR, CTD, DG1, OBX, IPC, ROL } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class OMI_O23 extends TriggerEvent {
    static TriggerEvent = 'OMI_O23';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'IPC', sequence: '30', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, isGroup: true, groupPath: ['ORDER'] },
                ],
                groups: {
                    PATIENT: {
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'OBR', sequence: '17', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['ORDER'] },
                    { identifier: 'NTE', sequence: '18', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['ORDER'] },
                    { identifier: 'CTD', sequence: '19', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['ORDER'] },
                    ...
                    { identifier: 'IPC', sequence: '23', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, isGroup: true, groupPath: ['ORDER'] },
                ],
                groups: {
                    PATIENT: {
            ...
            2.6: {
                sequences: [
                    ...
                    { identifier: 'ROL', sequence: '20', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['ORDER'] },
                    { identifier: 'CTD', sequence: '21', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['ORDER'] },
                    ...
                    { identifier: 'IPC', sequence: '25', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, isGroup: true, groupPath: ['ORDER'] },
                ],
                groups: {
                    PATIENT: {
            ...
            2.7: {
                sequences: [
                    ...
                    { identifier: 'OBR', sequence: '20', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['ORDER'] },
                    ...
                    { identifier: 'CTD', sequence: '23', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['ORDER'] },
                    ...
                    { identifier: 'IPC', sequence: '28', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, isGroup: true, groupPath: ['ORDER'] },
                ],
                groups: {
                    PATIENT: {
