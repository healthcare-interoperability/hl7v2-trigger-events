import { MSH, MSA, ERR, TQ1, NTE, PID, PV1, PV2, DG1, RGS, AIS, AIG, AIL, AIP, SCH } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class SRR_S01 extends TriggerEvent {
    static TriggerEvent = 'SRR_S01';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'TQ1', sequence: '4', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['SCHEDULE'] },
        ...
        segments: { MSH: MSH, MSA: MSA, ERR: ERR, TQ1: TQ1, NTE: NTE, PID: PID, PV1: PV1, PV2: PV2, DG1: DG1, RGS: RGS, AIS: AIS, AIG: AIG, AIL: AIL, AIP: AIP, SCH: SCH },
    };
