import { MSH, EVN, PID, PD1, MRG, SFT, UAC, ARV } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ADT_A34 extends TriggerEvent {
    static TriggerEvent = 'ADT_A34';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
        ...
        segments: { MSH: MSH, EVN: EVN, PID: PID, PD1: PD1, MRG: MRG, SFT: SFT, UAC: UAC, ARV: ARV },
    };
