import { MSH, NTE, PID, PD1, PV1, PV2, IN1, IN2, IN3, GT1, AL1, ORC, RXO, RXR, RXC, OBX, BLG } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class RDO_O01 extends TriggerEvent {
    static TriggerEvent = 'RDO_O01';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
                    ...
                    { identifier: 'OBX', sequence: '19', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['ORDER', 'ORDER_DETAIL', 'OBSERVATION'] },
                    { identifier: 'NTE', sequence: '20', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['ORDER', 'ORDER_DETAIL', 'OBSERVATION'] },
                    { identifier: 'BLG', sequence: '21', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['ORDER'] },
                ],
                groups: {
                    PATIENT: {
                    ...
                    ORDER: {
                        ...
                        subgroup: {
                            ORDER_DETAIL: {
                                ...
                                restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 },
                                subgroup: {
                                    COMPONENT: { sequence: { start: '17', stop: '18' }, restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, subgroup: {} },
        ...
        segments: { MSH: MSH, NTE: NTE, PID: PID, PD1: PD1, PV1: PV1, PV2: PV2, IN1: IN1, IN2: IN2, IN3: IN3, GT1: GT1, AL1: AL1, ORC: ORC, RXO: RXO, RXR: RXR, RXC: RXC, OBX: OBX, BLG: BLG },
    };
