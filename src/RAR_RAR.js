import { MSH, MSA, ERR, QRD, QRF, PID, NTE, ORC, RXE, RXR, RXC, RXA, DSC, SFT, UAC } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class RAR_RAR extends TriggerEvent {
    static TriggerEvent = 'RAR_RAR';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
                    ...
                    { identifier: 'RXA', sequence: '12', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, isGroup: true, groupPath: ['DEFINITION', 'ORDER'] },
                    { identifier: 'RXR', sequence: '13', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['DEFINITION', 'ORDER'] },
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'RXA', sequence: '13', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, isGroup: true, groupPath: ['DEFINITION', 'ORDER'] },
                    { identifier: 'RXR', sequence: '14', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['DEFINITION', 'ORDER'] },
            ...
            2.6: {
                sequences: [
                    ...
                    { identifier: 'RXA', sequence: '14', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, isGroup: true, groupPath: ['DEFINITION', 'ORDER'] },
                    { identifier: 'RXR', sequence: '15', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['DEFINITION', 'ORDER'] },
        ...
        segments: { MSH: MSH, MSA: MSA, ERR: ERR, QRD: QRD, QRF: QRF, PID: PID, NTE: NTE, ORC: ORC, RXE: RXE, RXR: RXR, RXC: RXC, RXA: RXA, DSC: DSC, SFT: SFT, UAC: UAC },
    };
