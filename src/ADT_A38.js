import { MSH, SFT, UAC, EVN, PID, PD1, PV1, PV2, DB1, OBX, DG1, DRG } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ADT_A38 extends TriggerEvent {
    static TriggerEvent = 'ADT_A38';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'DRG', sequence: '11', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: { ref: '2.8' },
            },
            '2.5.1': {
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EVN: EVN, PID: PID, PD1: PD1, PV1: PV1, PV2: PV2, DB1: DB1, OBX: OBX, DG1: DG1, DRG: DRG },
    };
