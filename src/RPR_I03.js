import { MSH, SFT, UAC, MSA, PRD, CTD, PID, NTE } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class RPR_I03 extends TriggerEvent {
    static TriggerEvent = 'RPR_I03';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
            ...
            2.3: {
                sequences: [
                    ...
                    { identifier: 'PID', sequence: '5', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'PID', sequence: '6', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
            ...
            2.6: {
                sequences: [
                    ...
                    { identifier: 'PRD', sequence: '5', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['PROVIDER'] },
                    { identifier: 'CTD', sequence: '6', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['PROVIDER'] },
                    { identifier: 'PID', sequence: '7', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
                    { identifier: 'NTE', sequence: '8', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
                ],
                groups: { ref: '2.8' },
            },
        },
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, MSA: MSA, PRD: PRD, CTD: CTD, PID: PID, NTE: NTE },
    };
