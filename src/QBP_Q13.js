import { MSH, SFT, UAC, QPD, Hxx, RDF, RCP, DSC, EVN } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class QBP_Q13 extends TriggerEvent {
    static TriggerEvent = 'QBP_Q13';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'RDF', sequence: '6', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'RDF', sequence: '4', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, QPD: QPD, Hxx: Hxx, RDF: RDF, RCP: RCP, DSC: DSC, EVN: EVN },
    };
