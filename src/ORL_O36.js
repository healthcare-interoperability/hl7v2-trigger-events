...
export class ORL_O36 extends TriggerEvent {
    static TriggerEvent = 'ORL_O36';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'NTE', sequence: '13', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['RESPONSE', 'SPECIMEN'] },
                    { identifier: 'SAC', sequence: '14', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['RESPONSE', 'SPECIMEN', 'SPECIMEN_CONTAINER'] },
                    {
                        identifier: 'ORC',
                        sequence: '15',
                        restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 },
                        isGroup: true,
                        groupPath: ['RESPONSE', 'SPECIMEN', 'SPECIMEN_CONTAINER', 'ORDER'],
                    },
                    {
                        identifier: 'PRT',
                        sequence: '16',
                    ...
                    },
                    {
                        ...
                        restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 },
                        isGroup: true,
                        groupPath: ['RESPONSE', 'SPECIMEN', 'SPECIMEN_CONTAINER', 'ORDER', 'TIMING'],
                    },
                    {
                        identifier: 'TQ2',
                        sequence: '18',
                    ...
                    },
                    {
                        ...
                        restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 },
                        isGroup: true,
                        groupPath: ['RESPONSE', 'SPECIMEN', 'SPECIMEN_CONTAINER', 'ORDER', 'OBSERVATION_REQUEST'],
                    },
                    {
                        identifier: 'PRT',
                        sequence: '20',
                                        ...
                                        subgroup: {
                                            ORDER: {
                                                ...
                                                subgroup: {
                                                    ...
                                                    OBSERVATION_REQUEST: { sequence: { start: '19', stop: '20' }, restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, subgroup: {} },
                                                },
                                            },
                                        },
                                    },
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'OBX', sequence: '8', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['RESPONSE', 'PATIENT', 'SPECIMEN'] },
                    {
                        ...
                        restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 },
                        isGroup: true,
                        groupPath: ['RESPONSE', 'PATIENT', 'SPECIMEN', 'SPECIMEN_CONTAINER'],
                    },
                    {
                        identifier: 'ORC',
                        sequence: '10',
                        restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 },
                        isGroup: true,
                        groupPath: ['RESPONSE', 'PATIENT', 'SPECIMEN', 'SPECIMEN_CONTAINER', 'ORDER'],
                    },
                    {
                        identifier: 'TQ1',
                        sequence: '11',
                        restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 },
                        isGroup: true,
                        groupPath: ['RESPONSE', 'PATIENT', 'SPECIMEN', 'SPECIMEN_CONTAINER', 'ORDER', 'TIMING'],
                    },
                    {
                        identifier: 'TQ2',
                        sequence: '12',
                    ...
                    },
                    {
                        ...
                        restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 },
                        isGroup: true,
                        groupPath: ['RESPONSE', 'PATIENT', 'SPECIMEN', 'SPECIMEN_CONTAINER', 'ORDER', 'OBSERVATION_REQUEST'],
                    },
                ],
                groups: {
                    RESPONSE: {
                                                ...
                                                subgroup: {
                                                    ORDER: {
                                                        ...
                                                        subgroup: {
                                                            ...
                                                            OBSERVATION_REQUEST: { sequence: { start: '13', stop: '13' }, restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, subgroup: {} },
                                                        },
                                                    },
                                                },
                                            },
            ...
            2.6: {
                sequences: [
                    ...
                    { identifier: 'NTE', sequence: '10', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['RESPONSE', 'SPECIMEN'] },
                    { identifier: 'SAC', sequence: '11', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['RESPONSE', 'SPECIMEN', 'SPECIMEN_CONTAINER'] },
                    {
                        identifier: 'ORC',
                        sequence: '12',
                        restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 },
                                        ...
                                        subgroup: {
                                            ORDER: {
                                                ...
                                                subgroup: {
                                                    ...
                                                    OBSERVATION_REQUEST: { sequence: { start: '15', stop: '16' }, restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, subgroup: {} },
                                                },
                                            },
                                        },
                                    },
            ...
            2.7: {
                sequences: [
                    ...
                    { identifier: 'NTE', sequence: '12', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['RESPONSE', 'SPECIMEN'] },
                    { identifier: 'SAC', sequence: '13', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['RESPONSE', 'SPECIMEN', 'SPECIMEN_CONTAINER'] },
                    {
                        identifier: 'ORC',
                        sequence: '14',
                        restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 },
