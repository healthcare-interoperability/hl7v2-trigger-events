import { MSH, SFT, UAC, QPD, Hxx, RDF, RCP, DSC } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class QBP_Z99 extends TriggerEvent {
    static TriggerEvent = 'QBP_Z99';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, QPD: QPD, Hxx: Hxx, RDF: RDF, RCP: RCP, DSC: DSC },
    };
