import { MSH, SFT, UAC, EVN, PID, PD1, PV1, DB1 } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ADT_A37 extends TriggerEvent {
    static TriggerEvent = 'ADT_A37';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'PV1', sequence: '11', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
            ...
            2.3: {
                sequences: [
                    ...
                    { identifier: 'DB1', sequence: '6', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'PD1', sequence: '9', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                    { identifier: 'PV1', sequence: '10', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EVN: EVN, PID: PID, PD1: PD1, PV1: PV1, DB1: DB1 },
    };
