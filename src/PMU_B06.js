import { MSH, SFT, UAC, EVN, STF, PRA, ORG } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class PMU_B06 extends TriggerEvent {
    static TriggerEvent = 'PMU_B06';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
            ...
            2.4: {
                sequences: [
                    ...
                    { identifier: 'ORG', sequence: '5', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: { ref: '2.8' },
            },
            2.5: {
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EVN: EVN, STF: STF, PRA: PRA, ORG: ORG },
    };
