import { MSH, SFT, UAC, EVN, PID, PD1, ARV, ROL, PV1, PV2, DB1, OBX, PDA } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ADT_A02 extends TriggerEvent {
    static TriggerEvent = 'ADT_A02';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'ARV', sequence: '11', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
                    ...
                    { identifier: 'PDA', sequence: '15', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: {},
            },
            2.6: {
            ...
            2.4: {
                sequences: [
                    ...
                    { identifier: 'PDA', sequence: '11', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: { ref: '2.8' },
            },
            2.5: {
                sequences: [
                    ...
                    { identifier: 'PDA', sequence: '12', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: { ref: '2.8' },
            },
            '2.5.1': {
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EVN: EVN, PID: PID, PD1: PD1, ARV: ARV, ROL: ROL, PV1: PV1, PV2: PV2, DB1: DB1, OBX: OBX, PDA: PDA },
    };
