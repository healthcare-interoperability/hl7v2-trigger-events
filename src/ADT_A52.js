import { MSH, SFT, UAC, EVN, PID, PD1, PV1, PV2 } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ADT_A52 extends TriggerEvent {
    static TriggerEvent = 'ADT_A52';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EVN: EVN, PID: PID, PD1: PD1, PV1: PV1, PV2: PV2 },
    };
