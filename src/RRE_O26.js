import { MSH, MSA, ERR, SFT, UAC, NTE, PID, ORC, TQ1, TQ2, RXE, RXR, RXC, PRT } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class RRE_O26 extends TriggerEvent {
    static TriggerEvent = 'RRE_O26';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
        ...
        segments: { MSH: MSH, MSA: MSA, ERR: ERR, SFT: SFT, UAC: UAC, NTE: NTE, PID: PID, ORC: ORC, TQ1: TQ1, TQ2: TQ2, RXE: RXE, RXR: RXR, RXC: RXC, PRT: PRT },
    };
