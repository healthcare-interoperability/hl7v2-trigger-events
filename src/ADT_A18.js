import { MSH, EVN, PID, PD1, MRG, PV1, SFT } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ADT_A18 extends TriggerEvent {
    static TriggerEvent = 'ADT_A18';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
        ...
        segments: { MSH: MSH, EVN: EVN, PID: PID, PD1: PD1, MRG: MRG, PV1: PV1, SFT: SFT },
    };
