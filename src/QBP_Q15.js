import { MSH, SFT, UAC, QPD, Hxx, RCP, DSC, RDF, EVN } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class QBP_Q15 extends TriggerEvent {
    static TriggerEvent = 'QBP_Q15';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'Hxx', sequence: '5', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, QPD: QPD, Hxx: Hxx, RCP: RCP, DSC: DSC, RDF: RDF, EVN: EVN },
    };
