import { MSH, MSA, ERR, QAK, DSP, DSC, SFT } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class EDR_R07 extends TriggerEvent {
    static TriggerEvent = 'EDR_R07';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
        ...
        segments: { MSH: MSH, MSA: MSA, ERR: ERR, QAK: QAK, DSP: DSP, DSC: DSC, SFT: SFT },
    };
