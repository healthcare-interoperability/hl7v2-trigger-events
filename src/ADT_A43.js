import { MSH, SFT, UAC, EVN, PID, PD1, MRG } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ADT_A43 extends TriggerEvent {
    static TriggerEvent = 'ADT_A43';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                ...
                groups: { PATIENT: { sequence: { start: '5', stop: '7' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} } },
            },
            2.6: {
                sequences: { ref: '2.8' },
                groups: { ref: '2.8' },
            ...
            2.5: {
                ...
                groups: { PATIENT: { sequence: { start: '4', stop: '6' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} } },
            },
            '2.5.1': {
                sequences: { ref: '2.5' },
                groups: { ref: '2.5' },
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EVN: EVN, PID: PID, PD1: PD1, MRG: MRG },
    };
