import { MSH, MSA, ERR, QRD, QRF, MFI, MFE, DSC, SFT, QAK, CDM, PRC, UAC } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class MFR_M04 extends TriggerEvent {
    static TriggerEvent = 'MFR_M04';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'CDM', sequence: '10', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['MF_QUERY'] },
                    { identifier: 'PRC', sequence: '11', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['MF_QUERY'] },
            ...
            2.6: {
                sequences: [
                    ...
                    { identifier: 'CDM', sequence: '11', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['MF_QUERY'] },
                    { identifier: 'PRC', sequence: '12', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['MF_QUERY'] },
                    { identifier: 'DSC', sequence: '13', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: { MF_QUERY: { sequence: { start: '10', stop: '12' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} } },
            },
        },
        segments: { MSH: MSH, MSA: MSA, ERR: ERR, QRD: QRD, QRF: QRF, MFI: MFI, MFE: MFE, DSC: DSC, SFT: SFT, QAK: QAK, CDM: CDM, PRC: PRC, UAC: UAC },
    };
