import { MSH, SFT, ARV, UAC, PID, PRT, PV1, CSR, CSP } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class CRM_C05 extends TriggerEvent {
    static TriggerEvent = 'CRM_C05';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'ARV', sequence: '3', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
        ...
        segments: { MSH: MSH, SFT: SFT, ARV: ARV, UAC: UAC, PID: PID, PRT: PRT, PV1: PV1, CSR: CSR, CSP: CSP },
    };
