import { MSH, SFT, UAC, MSA, ERR, QAK, QPD, Hxx, DSC, DSP } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class RDY_Z80 extends TriggerEvent {
    static TriggerEvent = 'RDY_Z80';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, MSA: MSA, ERR: ERR, QAK: QAK, QPD: QPD, Hxx: Hxx, DSC: DSC, DSP: DSP },
    };
