import { MSH, SFT, UAC, EVN, PID, PV1 } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class BAR_P06 extends TriggerEvent {
    static TriggerEvent = 'BAR_P06';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
            ...
            2.3: {
                ...
                groups: { PATIENT: { sequence: { start: '3', stop: '4' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} } },
            },
            '2.3.1': {
                sequences: { ref: '2.3' },
                groups: { ref: '2.3' },
            ...
            2.5: {
                ...
                groups: { PATIENT: { sequence: { start: '4', stop: '5' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} } },
            },
            '2.5.1': {
                sequences: { ref: '2.5' },
                groups: { ref: '2.5' },
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EVN: EVN, PID: PID, PV1: PV1 },
    };
