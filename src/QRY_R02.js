...
export class QRY_R02 extends TriggerEvent {
    static TriggerEvent = 'QRY_R02';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
                    ...
                    { identifier: 'QRF', sequence: '3', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: false },
                ],
                groups: {},
            },
            '2.3.1': {
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'QRF', sequence: '4', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: false },
                ],
                groups: { ref: '2.3' },
            },
            '2.5.1': {
            ...
            2.6: {
                sequences: [
                    ...
                    { identifier: 'QRF', sequence: '5', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: false },
                ],
                groups: { ref: '2.3' },
            },
        },
