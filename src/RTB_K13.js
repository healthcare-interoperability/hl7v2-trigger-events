...
export class RTB_K13 extends TriggerEvent {
    static TriggerEvent = 'RTB_K13';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
            ...
            2.4: {
                sequences: [
                    ...
                    { identifier: 'RDF', sequence: '6', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['ROW_DEFINITION'] },
                    { identifier: 'RDT', sequence: '7', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['ROW_DEFINITION'] },
                    { identifier: 'DSC', sequence: '8', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: { ROW_DEFINITION: { sequence: { start: '6', stop: '7' }, restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, subgroup: {} } },
            },
            2.5: {
                sequences: [
                    {},
