import { MSH, SFT, UAC, EQU, EQP, ROL } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class LSR_U13 extends TriggerEvent {
    static TriggerEvent = 'LSR_U13';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'EQP', sequence: '5', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, isGroup: false },
                ],
                groups: {},
            },
            2.4: {
                sequences: [
                    ...
                    { identifier: 'EQP', sequence: '3', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, isGroup: false },
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'EQP', sequence: '4', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, isGroup: false },
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EQU: EQU, EQP: EQP, ROL: ROL },
    };
