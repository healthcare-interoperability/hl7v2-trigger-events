...
export class BAR_P02 extends TriggerEvent {
    static TriggerEvent = 'BAR_P02';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'DB1', sequence: '8', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['PATIENT'] },
                ],
            ...
            2.3: {
                sequences: [
                    ...
                    { identifier: 'DB1', sequence: '6', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['PATIENT'] },
                ],
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'DB1', sequence: '7', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['PATIENT'] },
                ],
