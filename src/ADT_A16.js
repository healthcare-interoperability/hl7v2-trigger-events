import { MSH, SFT, UAC, EVN, PID, PD1, ARV, ROL, NK1, PV1, PV2, DB1, OBX, AL1, DG1, DRG, PR1, GT1, IN1, IN2, IN3, AUT, RF1, ACC } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ADT_A16 extends TriggerEvent {
    static TriggerEvent = 'ADT_A16';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
