import { MSH, MSA, ERR, QRD, QRF, PID, NTE, ORC, RXO, RXR, RXC, DSC, SFT, UAC } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ROR_ROR extends TriggerEvent {
    static TriggerEvent = 'ROR_ROR';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
                    ...
                    { identifier: 'RXO', sequence: '9', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['DEFINITION', 'ORDER'] },
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'RXO', sequence: '10', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['DEFINITION', 'ORDER'] },
            ...
            2.6: {
                sequences: [
                    ...
                    { identifier: 'RXO', sequence: '11', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['DEFINITION', 'ORDER'] },
        ...
        segments: { MSH: MSH, MSA: MSA, ERR: ERR, QRD: QRD, QRF: QRF, PID: PID, NTE: NTE, ORC: ORC, RXO: RXO, RXR: RXR, RXC: RXC, DSC: DSC, SFT: SFT, UAC: UAC },
    };
