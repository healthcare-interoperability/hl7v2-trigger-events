import { MSH, SFT, UAC, EVN, PID, PD1, PRT, ROL, PV1, PV2, DB1, OBX, AL1, DG1, DRG, PR1, GT1, NK1, IN1, IN2, IN3, ACC, UB1, UB2, ABS, BLC, RMI } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class BAR_P05 extends TriggerEvent {
    static TriggerEvent = 'BAR_P05';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'ABS', sequence: '31', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['VISIT'] },
                    { identifier: 'BLC', sequence: '32', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['VISIT'] },
                    { identifier: 'RMI', sequence: '33', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['VISIT'] },
                ],
                groups: {
                    VISIT: {
            ...
            2.4: {
                sequences: [
                    ...
                    { identifier: 'ABS', sequence: '25', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['VISIT'] },
                    { identifier: 'BLC', sequence: '26', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['VISIT'] },
                    { identifier: 'RMI', sequence: '27', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['VISIT'] },
                ],
                groups: {
                    VISIT: {
                        sequence: { start: '6', stop: '27' },
                        restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 },
                        subgroup: {
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'ABS', sequence: '26', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['VISIT'] },
                    { identifier: 'BLC', sequence: '27', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['VISIT'] },
                    { identifier: 'RMI', sequence: '28', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['VISIT'] },
                ],
                groups: {
                    VISIT: {
                        sequence: { start: '7', stop: '28' },
                        restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 },
                        subgroup: {
            ...
            2.6: {
                sequences: [
                    ...
                    { identifier: 'ABS', sequence: '27', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['VISIT'] },
                    { identifier: 'BLC', sequence: '28', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['VISIT'] },
                    { identifier: 'RMI', sequence: '29', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['VISIT'] },
                ],
                groups: {
                    VISIT: {
                        sequence: { start: '8', stop: '29' },
                        restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 },
                        subgroup: {
