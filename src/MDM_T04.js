import { MSH, SFT, UAC, EVN, PID, PV1, ORC, TQ1, TQ2, OBR, NTE, TXA, CON, OBX } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class MDM_T04 extends TriggerEvent {
    static TriggerEvent = 'MDM_T04';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'OBX', sequence: '14', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['OBSERVATION'] },
                    { identifier: 'NTE', sequence: '15', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['OBSERVATION'] },
                ],
                groups: {
                    COMMON_ORDER: {
            ...
            2.3: {
                sequences: [
                    ...
                    { identifier: 'OBX', sequence: '6', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, isGroup: false },
                ],
                groups: {},
            },
            '2.3.1': {
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'TXA', sequence: '11', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                    { identifier: 'OBX', sequence: '12', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['OBXNTE'] },
                    { identifier: 'NTE', sequence: '13', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['OBXNTE'] },
                ],
                groups: {
                    COMMON_ORDER: {
                    ...
                    OBXNTE: { sequence: { start: '12', stop: '13' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} },
                },
            },
            '2.5.1': {
                sequences: { ref: '2.5' },
            ...
            2.6: {
                sequences: [
                    ...
                    { identifier: 'NTE', sequence: '11', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['COMMON_ORDER'] },
                    { identifier: 'TXA', sequence: '12', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: false },
                    { identifier: 'OBX', sequence: '13', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['OBXNTE'] },
                    { identifier: 'NTE', sequence: '14', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['OBXNTE'] },
                ],
                groups: {
                    COMMON_ORDER: {
                        sequence: { start: '7', stop: '11' },
                    ...
                    OBXNTE: { sequence: { start: '13', stop: '14' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} },
                },
            },
        },
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EVN: EVN, PID: PID, PV1: PV1, ORC: ORC, TQ1: TQ1, TQ2: TQ2, OBR: OBR, NTE: NTE, TXA: TXA, CON: CON, OBX: OBX },
    };
