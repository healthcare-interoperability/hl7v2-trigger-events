import { MSH, MSA, ERR, QRD, QRF, MFI, MFE, DSC, SFT, UAC, QAK } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class MFR_M01 extends TriggerEvent {
    static TriggerEvent = 'MFR_M01';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
            ...
            2.6: {
                ...
                groups: { MF_QUERY: { sequence: { start: '10', stop: '10' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} } },
            },
        },
        segments: { MSH: MSH, MSA: MSA, ERR: ERR, QRD: QRD, QRF: QRF, MFI: MFI, MFE: MFE, DSC: DSC, SFT: SFT, UAC: UAC, QAK: QAK },
    };
