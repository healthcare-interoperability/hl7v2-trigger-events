import { MSH, SFT, UAC, MSA, ERR, QAK, QPD, Hxx, DSC } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class RSP_K11 extends TriggerEvent {
    static TriggerEvent = 'RSP_K11';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, MSA: MSA, ERR: ERR, QAK: QAK, QPD: QPD, Hxx: Hxx, DSC: DSC },
    };
