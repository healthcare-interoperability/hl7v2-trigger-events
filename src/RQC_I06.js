...
export class RQC_I06 extends TriggerEvent {
    static TriggerEvent = 'RQC_I06';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
                    ...
                    { identifier: 'GT1', sequence: '8', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
            ...
            2.6: {
                sequences: [
                    ...
                    { identifier: 'GT1', sequence: '10', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
