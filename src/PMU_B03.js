import { MSH, SFT, UAC, EVN, STF } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class PMU_B03 extends TriggerEvent {
    static TriggerEvent = 'PMU_B03';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EVN: EVN, STF: STF },
    };
