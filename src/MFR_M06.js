import { MSH, MSA, ERR, QRD, QRF, MFI, MFE, DSC, SFT, QAK, CM0, CM1, CM2 } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class MFR_M06 extends TriggerEvent {
    static TriggerEvent = 'MFR_M06';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'CM1', sequence: '11', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['MF_QUERY'] },
                    { identifier: 'CM2', sequence: '12', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['MF_QUERY'] },
                    { identifier: 'DSC', sequence: '13', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: { MF_QUERY: { sequence: { start: '9', stop: '12' }, restrictions: { nillable: false, minOccurs: 1, maxOccurs: 9999 }, subgroup: {} } },
            },
            '2.5.1': {
                sequences: { ref: '2.5' },
                groups: { ref: '2.5' },
            ...
            2.6: {
                sequences: [
                    ...
                    { identifier: 'MFE', sequence: '9', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['MF_QUERY'] },
                    { identifier: 'CM0', sequence: '10', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['MF_QUERY'] },
                    { identifier: 'CM1', sequence: '11', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['MF_QUERY', 'MF_CLINICAL_STUDY'] },
                    { identifier: 'CM2', sequence: '12', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['MF_QUERY', 'MF_CLINICAL_STUDY'] },
                    { identifier: 'DSC', sequence: '13', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: {
                    MF_QUERY: {
                        ...
                        subgroup: { MF_CLINICAL_STUDY: { sequence: { start: '11', stop: '12' }, restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, subgroup: {} } },
                    },
                },
            },
        },
        segments: { MSH: MSH, MSA: MSA, ERR: ERR, QRD: QRD, QRF: QRF, MFI: MFI, MFE: MFE, DSC: DSC, SFT: SFT, QAK: QAK, CM0: CM0, CM1: CM1, CM2: CM2 },
    };
