import { MSH, SFT, UAC, EVN, PID, PD1, ARV, ROL, PV1, PV2, DB1, OBX, DG1 } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ADT_A15 extends TriggerEvent {
    static TriggerEvent = 'ADT_A15';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EVN: EVN, PID: PID, PD1: PD1, ARV: ARV, ROL: ROL, PV1: PV1, PV2: PV2, DB1: DB1, OBX: OBX, DG1: DG1 },
    };
