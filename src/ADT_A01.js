import { MSH, SFT, UAC, EVN, PID, PD1, ARV, ROL, NK1, PV1, PV2, DB1, OBX, AL1, DG1, DRG, PR1, GT1, IN1, IN2, IN3, AUT, RF1, ACC, UB1, UB2, PDA } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ADT_A01 extends TriggerEvent {
    static TriggerEvent = 'ADT_A01';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'PDA', sequence: '31', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: {
            ...
            2.4: {
                sequences: [
                    ...
                    { identifier: 'PDA', sequence: '25', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: {
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'PDA', sequence: '26', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: {
