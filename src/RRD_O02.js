import { MSH, MSA, ERR, NTE, PID, ORC, RXD, RXR, RXC } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class RRD_O02 extends TriggerEvent {
    static TriggerEvent = 'RRD_O02';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
        ...
        segments: { MSH: MSH, MSA: MSA, ERR: ERR, NTE: NTE, PID: PID, ORC: ORC, RXD: RXD, RXR: RXR, RXC: RXC },
    };
