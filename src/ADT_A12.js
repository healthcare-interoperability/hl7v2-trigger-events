import { MSH, SFT, UAC, EVN, PID, PD1, PV1, PV2, DB1, OBX, DG1 } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ADT_A12 extends TriggerEvent {
    static TriggerEvent = 'ADT_A12';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
            ...
            2.3: {
                sequences: [
                    ...
                    { identifier: 'DG1', sequence: '9', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: { ref: '2.8' },
            },
            '2.3.1': {
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'DG1', sequence: '10', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: { ref: '2.8' },
            },
            '2.5.1': {
            ...
            2.6: {
                sequences: [
                    ...
                    { identifier: 'DB1', sequence: '9', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
                    { identifier: 'OBX', sequence: '10', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
                    { identifier: 'DG1', sequence: '11', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: false },
                ],
                groups: { ref: '2.8' },
            },
        },
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EVN: EVN, PID: PID, PD1: PD1, PV1: PV1, PV2: PV2, DB1: DB1, OBX: OBX, DG1: DG1 },
    };
