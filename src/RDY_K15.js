import { MSH, SFT, UAC, MSA, ERR, QAK, QPD, DSP, DSC } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class RDY_K15 extends TriggerEvent {
    static TriggerEvent = 'RDY_K15';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'DSP', sequence: '8', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
            ...
            2.4: {
                sequences: [
                    ...
                    { identifier: 'DSP', sequence: '6', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'DSP', sequence: '7', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, MSA: MSA, ERR: ERR, QAK: QAK, QPD: QPD, DSP: DSP, DSC: DSC },
    };
