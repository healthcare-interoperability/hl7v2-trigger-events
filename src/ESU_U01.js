import { MSH, SFT, UAC, EQU, ISD, ROL } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class ESU_U01 extends TriggerEvent {
    static TriggerEvent = 'ESU_U01';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
                    ...
                    { identifier: 'ISD', sequence: '5', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
                ],
                groups: {},
            },
            2.4: {
                sequences: [
                    ...
                    { identifier: 'ISD', sequence: '3', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
            ...
            2.5: {
                sequences: [
                    ...
                    { identifier: 'ISD', sequence: '4', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: false },
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, EQU: EQU, ISD: ISD, ROL: ROL },
    };
