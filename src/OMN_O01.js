import { MSH, NTE, PID, PD1, PV1, PV2, IN1, IN2, IN3, GT1, AL1, ORC, RQD, RQ1, OBX, BLG } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class OMN_O01 extends TriggerEvent {
    static TriggerEvent = 'OMN_O01';
    static Structure = {
        versions: {
            2.3: {
                sequences: [
                    ...
                    { identifier: 'RQ1', sequence: '15', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 1 }, isGroup: true, groupPath: ['ORDER', 'ORDER_DETAIL'] },
                    { identifier: 'NTE', sequence: '16', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['ORDER', 'ORDER_DETAIL'] },
                    { identifier: 'OBX', sequence: '17', restrictions: { nillable: false, minOccurs: 1, maxOccurs: 1 }, isGroup: true, groupPath: ['ORDER', 'ORDER_DETAIL', 'OBSERVATION'] },
                    { identifier: 'NTE', sequence: '18', restrictions: { nillable: true, minOccurs: 0, maxOccurs: 9999 }, isGroup: true, groupPath: ['ORDER', 'ORDER_DETAIL', 'OBSERVATION'] },
        ...
        segments: { MSH: MSH, NTE: NTE, PID: PID, PD1: PD1, PV1: PV1, PV2: PV2, IN1: IN1, IN2: IN2, IN3: IN3, GT1: GT1, AL1: AL1, ORC: ORC, RQD: RQD, RQ1: RQ1, OBX: OBX, BLG: BLG },
    };
