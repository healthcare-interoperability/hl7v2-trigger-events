import { MSH, SFT, UAC, MSA, PRD, CTD, NTE, DSP, DSC } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class RPL_I02 extends TriggerEvent {
    static TriggerEvent = 'RPL_I02';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, MSA: MSA, PRD: PRD, CTD: CTD, NTE: NTE, DSP: DSP, DSC: DSC },
    };
