import { MSH, SFT, UAC, MSA, ERR, MFI, MFA, MFE, CM0, CM1, CM2 } from '@healthcare-interoperability/hl7v2-segments';
import { TriggerEvent } from '@healthcare-interoperability/hl7v2-core';

export class MFK_M06 extends TriggerEvent {
    static TriggerEvent = 'MFK_M06';
    static Structure = {
        versions: {
            2.8: {
                sequences: [
        ...
        segments: { MSH: MSH, SFT: SFT, UAC: UAC, MSA: MSA, ERR: ERR, MFI: MFI, MFA: MFA, MFE: MFE, CM0: CM0, CM1: CM1, CM2: CM2 },
    };
